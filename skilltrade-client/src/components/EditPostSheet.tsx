...
const EditPostSheet = ({ post, onPostUpdated, onClose }: EditPostSheetProps) => {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      toTeach: post.toTeach.join(", "),
      toLearn: post.toLearn.join(", "),
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      const response = await client.post(`/api/community/posts/${post.id}/update`, postData)
  ...
  return (
    <SheetContent className="w-[400px] sm:w-[540px] flex flex-col h-full">
      <SheetHeader className="flex-shrink-0 px-6 py-6 border-b">
        ...
        <SheetDescription>
          Update your post details. Make changes to your skills and availability.
        </SheetDescription>
      </SheetHeader>
